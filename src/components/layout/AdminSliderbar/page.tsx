...
export default function AdminSlideBar({
  ...
  const navItems = [
    ...
    { name: "Create & Manage Modules", icon: <BookOpen size={20} />, href: "/createmodule" },
    { name: "Create Resource", icon: <Plus size={20} />, href: "/createresource" },
    { name: "Manage Resource", icon: <Edit3 size={20} />, href: "/manageresource" },
    { name: "Student Contributions", icon: <Users size={20} />, href: "/studentcontributions" },
    { name: "Invite Moderator", icon: <UserPlus size={20} />, href: "/intivitemoderator" },
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="cursor-pointer py-6" onClick={toggleCollapse}>
          <motion.img
      ...
      <div className="px-4 pb-4">
        <div className={`flex items-center ${collapsed ? "justify-center" : "justify-between"} mt-4`}>
          <AnimatePresence mode="wait">
            {!collapsed && mounted && (
              <motion.div
                key="user-info"
