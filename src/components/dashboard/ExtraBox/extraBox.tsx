	...
	return (
        ...
        h-auto sm:min-h-[200px] md:h-[390px] cursor-pointer group ring ring-[#00000028] hover:shadow-[2px_3px_10px_rgba(0,0,0,0.5),_-1px_-1px_3px_rgba(0,0,0,0.1)]"
			...
			<div className="flex flex-col w-full h-full justify-between px-[clamp(1rem,2vw,1.25rem)] py-[clamp(0.75rem,1.5vw,1rem)] sm:py-[clamp(0.5rem,2vw,0.75rem)]">
				<div className="flex flex-col md:gap-[clamp(1rem,3vw,30px)] gap-[clamp(0.75rem,2vw,20px)]">
					<div className="flex items-center justify-between md:text-[clamp(14px,1.5vw,18px)] text-[clamp(12px,2vw,14px)] font-[300] text-[#000000CC]">
						<span className="truncate overflow-hidden whitespace-nowrap max-w-[60%]">
							{Subject}
						</span>
						<span className="border px-[clamp(0.75rem,1.5vw,1rem)] md:py-[clamp(0.4rem,1vw,0.5rem)] py-[clamp(0.3rem,1.5vw,0.4rem)] rounded-lg bg-[#74BF44] text-white font-semibold text-[clamp(10px,2vw,12px)] sm:text-[clamp(12px,2vw,14px)]">
							{Level}
						</span>
					</div>

					<div className="flex flex-col md:gap-[clamp(16px,2.2vw,22px)] gap-[clamp(12px,2vw,16px)]">
						<div className="flex items-center md:space-x-[clamp(20px,3vw,35px)] space-x-[clamp(8px,2vw,12px)]">
							<div className="md:py-[clamp(10px,1.5vw,14px)] py-[clamp(5px,1.5vw,8px)] md:px-[clamp(12px,2vw,17px)] px-[clamp(6px,2vw,10px)] rounded-lg bg-[#fbfbfb8f] ring ring-[#68686820]">
								<svg
									width="24"
									height="14"
									viewBox="0 0 24 14"
				...
				<div>
					<div>
						<div className="flex items-center text-[#000000CC] justify-between md:text-[clamp(13px,1.6vw,16px)] text-[clamp(11px,1.4vw,13px)] font-[300]">
							<span className="text-gray-600 text-[clamp(10px,1.3vw,12px)] sm:text-[clamp(11px,1.4vw,14px)]">
								{ResourcesContain}
							</span>
							<button className="flex md:space-x-[clamp(8px,1vw,12px)] space-x-[clamp(5px,1vw,8px)] items-center justify-center cursor-pointer">
								<span className="text-[#74BF44] font-[600] md:text-[clamp(12px,1.4vw,15px)] text-[clamp(10px,1vw,12px)]">
									Explore
								</span>
								<svg
									width="22"
